								...
								<div class="col-md-12">
									<div class="panel panel-primary">
										<div class="panel-heading ">
											<h2>ADD qac : Process Change Report System [<?echo $row_QAC_t["cta_name"]?>]</h2>
											<!-- <div class="panel-ctrls" data-actions-container="" data-action-collapse='{"target": ".panel-body"}'></div> -->
										</div>
										<div class="panel-body">
											<form class="form-horizontal" action="../ENG/add_qac.php?id=<?echo $_GET["id"]?>" method="post" enctype="multipart/form-data" >
												...
												<div class="form-group">
													...
													<div class="col-sm-5">
														<input type="text" class="form-control" disabled id="appdepart_department0" name="Con_password" value="<?echo $row_QAC_t["cta_name"]?>" >
													</div>
												</div>
