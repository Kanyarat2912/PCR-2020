							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-primary">
										...
										?>
											<form class="grid-form" action="../ENG/RJ_Result.php?pcr_number=<?echo $pcr_number?>" method="post" enctype="multipart/form-data" >
												<fieldset>
													<? echo Select_General($conn, $condbmc, $pcr_number); ?>
												</fieldset>
												<br>
												<fieldset>
													<? echo Select_Type($conn, $pcr_number); ?>
												</fieldset>		
												<br>
												<fieldset>
													<? echo Select_Risk($conn, $pcr_number); ?>
												</fieldset>
												<br>
												<fieldset>
													<? echo Select_Anuual($conn, $pcr_number); ?>
												</fieldset>
												<br>
												<br>
												<fieldset>
													<? echo Select_Priority($conn, $pcr_number); ?>			
												</fieldset>
												<br>
												<fieldset >
												...
												<fieldset>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2 ">
															<center><?echo date("d-M-yy", strtotime($implementation2[0]))?></center>
														</label>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2">
															<center><?echo date("d-M-yy", strtotime($implementation2[1]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2">
															<center><?echo date("d-M-yy", strtotime($implementation2[2]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2">
															<center><?echo date("d-M-yy", strtotime($implementation2[3]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2 ">
															<center><?echo date("d-M-yy", strtotime($implementation2[4]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd">
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2 ">
															<center><?echo date("d-M-yy", strtotime($implementation2[5]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2 ">
															<center><?echo date("d-M-yy", strtotime($implementation2[6]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-2 col-xs-2 col-md-2 col-lg-2 ">
															<center><?echo date("d-M-yy", strtotime($implementation2[7]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
