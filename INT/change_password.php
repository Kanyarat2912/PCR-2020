			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					<div class="panel panel-default">
						<form action="../ENG/change_password.php?Emp_ID=<?echo $_GET["emp"]?>&confirm=<?echo $_GET["confirm"]?>" method="POST" class="form-horizontal" id="form-login">
								...
								<div class="form-group mb-md">
									<div class="col-xs-12">
										<div class="input-group">							
											...
											<input type="text" name="username" class="form-control" value="<? echo $_GET["emp"]?>" disabled placeholder="Username" data-parsley-minlength="10" placeholder="At least 10 characters" required>
										</div>
									</div>
								</div>
