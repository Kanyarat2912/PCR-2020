								...
								<div class="col-md-12">
									<div class="panel panel-primary" data-widget='{"id" : "wiget9", "draggable": "false"}'>
										...
										<div class="panel-body">
											<form class="grid-form" action="../ENG/Insert_pcr_plan.php?pcr_number=<?echo $pcr_num?>&number=<?echo $data["seq"]?>" method="post" enctype="multipart/form-data" >
												<fieldset>
													<legend>General Data</legend>
													<div data-row-span="4">
														<div data-field-span="1">
															<label>No.</label>
															<input type="text" value="<?echo $pcr_num?>" disabled>
														</div>
														<div data-field-span="1">
															<label>Date</label>
