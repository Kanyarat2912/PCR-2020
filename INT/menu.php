		...
		<div class="sidebar">
			<div class="widget">
				<div class="widget-body">
					<div class="userinfo">
						<div class="avatar">
							<img src="http://10.73.148.5/DBMC/IMG/emp120/<?echo $_SESSION["empid_pcr"]?>.jpg" class="img-responsive img-circle"> 
						</div>
						<div class="info">
							<span class="username"><?echo $_SESSION["empname_pcr"]." ".substr($_SESSION["emplast_pcr"],0,1)."."; ?></span>
							<br>
							<span class="useremail"><?echo $_SESSION["dept_pcr"] ?></span>
						</div>
					</div>
				</div>
			</div>
			<div class="widget stay-on-collapse" id="widget-sidebar">
				<nav role="navigation" class="widget-body">
					<ul class="acc-menu">
						...
						<li><a href="app_dept.php"><i class="ti ti-email"></i><span>My Pending</span><?echo $NUM?></a></li>
