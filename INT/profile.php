...
<li class="active"><a href="profile.php?Emp_ID=<?echo $_GET["Emp_ID"]?>">Profile</a></li>
		...
		<div class="col-sm-3">
			<div class="panel panel-profile">
			  <div class="panel-body">
			    <img src="http://10.73.148.5/DBMC/IMG/emp120/<?echo $_GET["Emp_ID"]?>.jpg" class="img-circle">
			    <div class="name"><?echo $Name?></div>
			    <div class="info"><?echo $SP?></div>
			  </div>
			</div><!-- panel -->
		</div><!-- col-sm-3 -->
		<div class="col-sm-9">
								    ...
								    <div class="table-responsive">
								      <table class="table about-table">
								        <tbody>
								          <tr>
								            <th>Full Name</th>
								            <td><?echo $row_name["Empname_engTitle"].' '.$row_name["Empname_eng"].'  '.$row_name["Empsurname_eng"]?></td>
								          </tr>
								          <tr>
								            <th>Position</th>
								            <td><?echo $row_p["Position_name"]?></td>
								          </tr>
								          <tr>
								            <th>Department</th>
								            <td><?echo $row_gc["Department"]?></td>
								          </tr>
								          <tr>
								            <th>Section</th>
								            <td><?echo $row_gc["Sec_desc"]?></td>
								          </tr>
								          <tr>
								            <th>Section Code</th>
								            <td><?echo $row_gc["Sectioncode"]?></td>
								          </tr>
								        </tbody>
								      </table>
								    </div>
