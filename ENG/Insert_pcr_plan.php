...
$sql_PCR_Form = "INSERT INTO pcr_form 
				(fm_pcr_number,fm_pcr_leadtime,fm_part_number,fm_anp_id,fm_usr_emp_code,fm_quality,fm_safety,fm_delivery,fm_flowout)
				VALUES ('".$number_pcr."','".$pcr_type."','".$part_number."','".$anuual_Plan_No."','".$emp_code."','".$quality."','".$safety."','".$delivery."','".$part_test."')";
