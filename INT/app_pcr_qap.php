...
<div id="wrapper">
	...
	<div class="static-content-wrapper">
									...
									<form class="grid-form">
										<div class="tab-content">
											<div class="tab-pane active" id="form">
												...
												<br>
												<fieldset>
													<? echo Select_file($conn, $pcr_number); ?>
												</fieldset>
												<br>
												<fieldset>
													<? echo Select_implementation($conn, $pcr_number); ?>
												</fieldset>
												<br>
												<fieldset>
													<? echo Select_attach_doc($conn, $pcr_number); ?>
												</fieldset>	
												<br>
												<fieldset>
												...
												<br>
												<fieldset>
													<? echo Select_BKD($conn, $condbmc, $pcr_number); ?>
												</fieldset>	
												<br>
											</div>
		...
		<form action="../ENG/Approver_qap.php?step=<?echo $row_pcr["fm_state_app"]?>&PCR=<?echo $pcr_number?>" method="post">
						...
						<div class="row">
								...
								?>
									<div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
										<label class="radio-inline icheck" >
											<input type="checkbox" id="meeting" name="meeting[]" value="<?echo $row_meeting["mt_id"]?>"><?echo $row_meeting["mt_name"]?>
										</label>
									</div>
								<?
								}
							...
							<div class="col-sm-12 col-xs-12 col-md-12col-lg-12">
								...
								?>
									<div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
										<label class="radio-inline icheck" >
											<input type="checkbox" name="meeting7" id="meeting7"  value="<?echo $row_meeting7["mt_id"]?>"><?echo $row_meeting7["mt_name"]?>
										</label>
									</div>
							</div>	
							<div class="col-sm-12 col-xs-12 col-md-12col-lg-12">
