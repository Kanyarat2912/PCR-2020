			...
			<div class="sidebar">
				<div class="widget">
					<div class="widget-body">
						<div class="userinfo">
							<div class="avatar">
								<img src="http://10.73.148.5/DBMC/IMG/emp120/<?echo $_GET["Emp_ID"]?>.jpg" class="img-responsive img-circle"> 
							</div>
							<div class="info">
								<span class="username"><?echo $row_emp["Empname_eng"]." ".substr($row_emp["Empname_eng"],0,1)."."; ?></span>
								<br>
								<span class="useremail"><?echo $row_p["Department"] ?></span>
							</div>
						</div>
					</div>
				</div>
									...
									<form class="grid-form">
										<div class="tab-content">
											<div class="tab-pane active" id="form">
												...
												<br>
												<fieldset>
													<? echo Select_file_cc($conn, $pcr_number, $_GET["Emp_ID"]); ?>
												</fieldset>
												<br>
												<fieldset>
