							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-primary">
										...
										?>
											<form class="grid-form" action="../ENG/RJ_plan.php?pcr_number=<?echo $pcr_number?>" method="post" enctype="multipart/form-data" >
												<fieldset>
													<legend>General Data</legend>
													<div data-row-span="4">
														<div data-field-span="1">
															<label>No.</label>
															<input type="text" value="<?echo $pcr_number?>" disabled>
														</div>
														<div data-field-span="1">
															<label>Date</label>
															<input type="text" value="<?echo date("d-M-y", strtotime($row_PCR["fm_create_date"]))?>" disabled>
														</div>
														<div data-field-span="1">
															<label>Registant</label>
															<input type="text" value="<?echo $_SESSION["empname_pcr"]." ".substr($_SESSION["emplast_pcr"],0,1)."."; ?>" disabled>
														</div>
														<div data-field-span="1">
															<label>Department</label>
															<input type="text" value="<?echo $_SESSION["dept_pcr"] ?>" disabled>
														</div>
													</div>
												</fieldset>
												<br>
													...
													<div class="form-group">
														...
														<div class="col-sm-2 col-xs-2 col-md-2 col-lg-2">
															<label class="radio-inline icheck" >
																<input type="radio" id="inlineradio1" style="color:#33cc33;" <?if($row_PCR["fm_pcr_leadtime"] == "Normal"){?>checked<?}?> value="1" name="normall_urgent" > Normal
															</label>
														</div>	
														<div class="col-sm-8 col-xs-8 col-md-8 col-lg-8">
															<label class="radio-inline icheck" >
																<input type="radio" id="inlineradio2" style="color:red;" <?if($row_PCR["fm_pcr_leadtime"] == "Urgent"){?>checked<?}?> value="0" name="normall_urgent" > Urgent
															</label>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-2 col-xs-2 col-md-2 col-lg-2">
															<label class="radio-inline icheck">
																<input type="radio" id="inlineradio1" value="1" name="Part_test_flow_out" <?if($row_PCR["fm_flowout"] == 1){?>checked<?}?> > Yes
															</label>
														</div>	
														<div class="col-sm-8 col-xs-8 col-md-8 col-lg-8">
															<label class="radio-inline icheck">
																<input type="radio" id="inlineradio2" value="0" name="Part_test_flow_out" <?if($row_PCR["fm_flowout"] == 0){?>checked<?}?> > No
															</label>
														</div>
													</div>
												</fieldset>
												...
												<fieldset>
													...
													<div class="form-group">
														...
														<div class="col-sm-2 col-xs-2 col-md-2 col-lg-2">
															<label class="radio-inline icheck" >
																<input type="radio" id="inlin" style="color:#33cc33;" value="1" name="quality" <?if($row_PCR["fm_quality"] == 1){?>checked<?}?> > Yes
															</label>
														</div>	
														<div class="col-sm-8 col-xs-8 col-md-8 col-lg-8">
															<label class="radio-inline icheck" >
																<input type="radio" id="inlineradio2" style="color:red;" value="0" name="quality" <?if($row_PCR["fm_quality"] == 0){?>checked<?}?> > No
															</label>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-2 col-xs-2 col-md-2 col-lg-2">
															<label class="radio-inline icheck">
																<input type="radio" id="inlineradio1" value="1" name="safety" <?if($row_PCR["fm_safety"] == 1){?>checked<?}?>> Yes
															</label>
														</div>	
														<div class="col-sm-8 col-xs-8 col-md-8 col-lg-8">
															<label class="radio-inline icheck">
																<input type="radio" id="inlineradio2" value="0" name="safety" <?if($row_PCR["fm_safety"] == 0){?>checked<?}?>> No
															</label>
														</div>
													</div>
													<div class="form-group">	
														...
														<div class="col-sm-2 col-xs-2 col-md-2 col-lg-2">
															<label class="radio-inline icheck">
																<input type="radio" id="inlineradio1" value="1" name="delivery" <?if($row_PCR["fm_delivery"] == 1){?>checked<?}?>> Yes
															</label>
														</div>
														<div class="col-sm-8 col-xs-8 col-md-8 col-lg-8">
															<label class="radio-inline icheck">
																<input type="radio" id="inlineradio2" value="0" name="delivery" <?if($row_PCR["fm_delivery"] == 0){?>checked<?}?>> No
															</label>
														</div>
													</div>
												</fieldset>
												...
												<fieldset>
													...
													<div data-row-span="2">
														<div data-field-span="1">
															...
															<input id="anuual_Plan_No"  list="suggestionList" value="<?echo $row_anu["anp_anp_number"]?>" type="text" name="anuual_Plan_No" required />
														...
														<div data-field-span="1">
															...
															?>
															<input type="text" name="addition_item" value="<?echo $Item?>" id="addition_item" disabled>
														</div>
													</div>
													<div data-row-span="1">
														<div data-field-span="1">
															<label>Title</label>
															<input type="text" name="title_pcr" value="<?echo $row_anu["anp_title"]?>" id="title_pcr" disabled>
														</div>
													</div>
													<div data-row-span="2">
														<div data-field-span="1">
															<label>Change Type</label>
															<input type="text" name="change_type" value="<?echo $row_CT["ct_name"]?>" id="change_type" disabled>
														</div>
														<div data-field-span="1">
															<label>Rank</label>
															<input type="text" name="rank" value="<?echo $row_RK["rk_name"]?>" id="rank" disabled >
														</div>
													</div>
													<div data-row-span="2">
														<div data-field-span="1">
															<label>Customer submission</label>
															<input type="text" name="customer_submission" value="<?echo $row_anu["anp_cus_sub"]?>" id="customer_submission" disabled>
														</div>
														<?
														...
														<div data-field-span="1">
															...
															<input type="text" name="planning_review" value="<?echo $anp_plan_review?>" id="planning_review" disabled>
														</div>
													</div>
													<div data-row-span="2">
														<div data-field-span="1">
															<label>Product</label>
															<input type="text" name="product" value="<?echo $row_PD["pro_name"]?>" id="product" disabled>
														</div>
														<div data-field-span="1">
															<label>Part Name</label>
															<input type="text" name="part_name" value="<?echo $row_anu["anp_part_name"]?>" id="part_name" disabled>
														</div>
													</div>
													<div data-row-span="2">
														<div data-field-span="1">
															<label><font color="#CC0000"><b>Part Number *</b></font></label>
															<input type="text" name="part_number" value="<?echo $row_PCR["fm_part_number"]?>" id="part_number" required>
														</div>
														<div data-field-span="1">
															<label>Change Point</label>
															<input type="text" name="change_point" value="<?echo $row_CP["cp_name"]?>" id="change_point" disabled>
														</div>
													</div>
												</fieldset>
												<br>
												...
												<fieldset>
													...
													<div class="col-sm-2 col-xs-2 col-md-2 col-lg-2 icheck-square">
														<div class="checkbox green icheck">
															<label><input type="checkbox" name="S[]" <?if($row_pmc_form){?>checked<?}?> value="<?echo $row_pmc["pri_id"]?>">
																<img src="../images/simbol/<?echo $row_pmc["pri_name"]?>.png" style="width:70px" class="img-circle" >
															</label>
														</div>
													</div>
													<?
												...
												<fieldset>
													...
													<div class="form-group">
														...
														<label class="col-sm-4 col-xs-4 col-md-4 col-lg-4 ">
															<center><?echo date("d-M-yy", strtotime($implementation[0]))?></center>
														</label>
													...
													<div class="form-group">
														...
														<label class="col-sm-4 col-xs-4 col-md-4 col-lg-4 ">
															<center><?echo date("d-M-yy", strtotime($implementation[1]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-4 col-xs-4 col-md-4 col-lg-4 ">
															<center><?echo date("d-M-yy", strtotime($implementation[2]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-4 col-xs-4 col-md-4 col-lg-4 ">
															<center><?echo date("d-M-yy", strtotime($implementation[3]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-4 col-xs-4 col-md-4 col-lg-4 ">
															<center><?echo date("d-M-yy", strtotime($implementation[4]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-4 col-xs-4 col-md-4 col-lg-4 ">
															<center><?echo date("d-M-yy", strtotime($implementation[5]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-4 col-xs-4 col-md-4 col-lg-4 ">
															<center><?echo date("d-M-yy", strtotime($implementation[6]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
													...
													<div class="form-group">
														...
														<label class="col-sm-4 col-xs-4 col-md-4 col-lg-4 ">
															<center><?echo date("d-M-yy", strtotime($implementation[7]))?></center>
														</label>
														<div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
															<div class="input-group  in-bd" >
																<span class="input-group-addon"><i class="ti ti-calendar"></i></span>
												...
												<fieldset>
													...
													<div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 icheck-square">
														<div class="checkbox green icheck">
															<label><input type="checkbox" <?if($row_at["att_pfmea"] != ""){?>checked<?}?> name="check_PFMEA" value="1">PFMEA</label>
														</div>
													</div>
													<div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 icheck-square">
														<div class="checkbox green icheck">
															<label><input type="checkbox" <?if($row_at["att_qa_network"] != ""){?>checked<?}?> name="check_qa_network" value="1">QA Network</label>
														</div>
													</div>
													<div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 icheck-square">
														<div class="checkbox green icheck">
															<label><input type="checkbox" <?if($row_at["att_control_plan"] != ""){?>checked<?}?> name="check_control_plan" value="1">Control plan ,PCC</label>
														</div>
													</div>
													<div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 icheck-square">
														<div class="checkbox green icheck">
															<label><input type="checkbox" <?if($row_at["att_wi"] != ""){?>checked<?}?> name="standardize" value="1">Standardize work , WI</label>
														</div>
													</div>
													<div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 icheck-square">
														<div class="checkbox green icheck">
															<label><input type="checkbox" <?if($row_at["att_machine_spec"] != ""){?>checked<?}?> name="machine_sprci" value="1">Machine specification</label>
														</div>
													</div>
													<div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 icheck-square">
														<div class="checkbox green icheck">
															<label><input type="checkbox" <?if($row_at["att_daily_check"] != ""){?>checked<?}?> name="daily_check" value="1">Daily check sheet</label>
														</div>
													</div>
													<div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 icheck-square">
														<div class="checkbox green icheck">
															<label><input type="checkbox" <?if($row_at["att_other"] != ""){?>checked<?}?> name="other" value="1">Other</label>
														</div>
													</div>
												</fieldset>	
												<br>
												<fieldset>
													...
													<div data-row-span="3">
														<div data-field-span="1">
															...
															<input type="text" id="appdepart_name0" value="<?echo $row_app1["ap_emp_code"]?>" name="appdepart_name0" list="list_app0">
														...
														<div data-field-span="1">
															...
															<input type="text" id="appdepart_Position0" value="<?echo Emp_Data($condbmc,$row_app1["ap_emp_code"], 1)?>" disabled>
														</div>
														<div data-field-span="1">
															<label>Position / Department</label>
															<input type="text" id="appdepart_department0" <?if($row_app1["ap_emp_code"] != ""){?> value="<?echo Emp_Data($condbmc,$row_app1["ap_emp_code"], 2)?>"<?}?> disabled>
														</div>
													</div>
													<div data-row-span="3">
														<div data-field-span="1">
															<label>(Checker 2) Employee ID.</label>
															<input type="text" id="appdepart_name1" value="<?echo $row_app2["ap_emp_code"]?>" name="appdepart_name1" list="list_app1">
														...
														<div data-field-span="1">
															<label>Name - surname</label>
															<input type="text" id="appdepart_Position1" value="<?echo Emp_Data($condbmc,$row_app2["ap_emp_code"], 1)?>" disabled>
														</div>
														<div data-field-span="1">
															<label>Position / Department</label>
															<input type="text" id="appdepart_department1" <?if($row_app2["ap_emp_code"] != ""){?> value="<?echo Emp_Data($condbmc,$row_app2["ap_emp_code"], 2)?>"<?}?> disabled>
														</div>
													</div>
													<div data-row-span="3">
														<div data-field-span="1">
															<label>(Checker 3) Employee ID.</label> 
															<input type="text" id="appdepart_name2" value="<?echo $row_app3["ap_emp_code"]?>" name="appdepart_name2" list="list_app2" >
														...
														<div data-field-span="1">
															<label>Name - surname</label>
															<input type="text" id="appdepart_Position2" value="<?echo Emp_Data($condbmc,$row_app3["ap_emp_code"], 1)?>" disabled>
														</div>
														<div data-field-span="1">
															<label>Position / Department</label>
															<input type="text" id="appdepart_department2" <?if($row_app3["ap_emp_code"] != ""){?> value="<?echo Emp_Data($condbmc,$row_app3["ap_emp_code"], 2)?>"<?}?> disabled>
														</div>
													</div>
													<div data-row-span="3">
														<div data-field-span="1">
															<label>(Checker 4) Employee ID.</label>
															<input type="text" id="appdepart_name3" value="<?echo $row_app4["ap_emp_code"]?>" name="appdepart_name3" list="list_app3" >
														...
														<div data-field-span="1">
															<label>Name - surname</label>
															<input type="text" id="appdepart_Position3" value="<?echo Emp_Data($condbmc,$row_app4["ap_emp_code"], 1)?>" disabled>
														</div>
														<div data-field-span="1">
															<label>Position / Department</label>
															<input type="text" id="appdepart_department3" <?if($row_app4["ap_emp_code"] != ""){?> value="<?echo Emp_Data($condbmc,$row_app4["ap_emp_code"], 2)?>"<?}?> disabled>
														</div>
													</div>
													<div data-row-span="3">
														<div data-field-span="1">
															<label>(Checker 5) Employee ID.</label>
															<input type="text" id="appdepart_name4" value="<?echo $row_app5["ap_emp_code"]?>" name="appdepart_name4" list="list_app4" >
														...
														<div data-field-span="1">
															<label>Name - surname</label>
															<input type="text" id="appdepart_Position4" value="<?echo Emp_Data($condbmc,$row_app5["ap_emp_code"], 1)?>" disabled>
														</div>
														<div data-field-span="1">
															<label>Position / Department</label>
															<input type="text" id="appdepart_department4" <?if($row_app5["ap_emp_code"] != ""){?> value="<?echo Emp_Data($condbmc,$row_app5["ap_emp_code"], 2)?>"<?}?> disabled>
														</div>
													</div>
													<div data-row-span="3">
														<div data-field-span="1">
															<label>(Final Approve) Employee ID.</label>
															<input list="list_Final" value="<?echo $row_app_f["ap_emp_code"]?>" id="appdepart_Final" type="text" name="appdepart_final"   required />
														...
														<div data-field-span="1">
															<label>Name - surname</label>
															<input type="text" id="appdepart_Pos_F" value="<?echo Emp_Data($condbmc,$row_app_f["ap_emp_code"], 1)?>" disabled>
														</div>
														<div data-field-span="1">
															<label>Position / Department</label>
															<input type="text" id="appdepart_department_F" value="<?echo Emp_Data($condbmc,$row_app_f["ap_emp_code"], 2)?>" disabled>
														</div>
													</div>
												</fieldset>
												<br>
												<fieldset>
													...
													<div data-row-span="3">
														<div data-field-span="1">
															...
															<input id="ackdepart_name" value="<?echo $row_app_a["ap_emp_code"]?>" list="list_ackdepart" type="text" name="ackdepart_name"   required />
														...
														<div data-field-span="1">
															<label>Name - surname</label>
															<input id="ackdepart_Position_first" type="text" value="<?echo Emp_Data($condbmc,$row_app_a["ap_emp_code"], 1)?>" name="ackdepart_Position_first" disabled>
														</div>
														<div data-field-span="1">
															<label>Position / Department</label>
															<input id="ackdepart_department" type="text" value="<?echo Emp_Data($condbmc,$row_app_a["ap_emp_code"], 2)?>" name="ackdepart_department" disabled>
														</div>
													</div>
												</fieldset>
												<br>
