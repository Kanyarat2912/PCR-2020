            ...
            <div class="static-content">
                <div class="page-content">
                    <ol class="breadcrumb">
						...
						<li class="active"><a href="#"><?echo $row_QAC_t["cta_name"]?></a></li>
					</ol>
				...
				<div data-widget-group="group1">
					<div class="row">
						<div class="col-md-12">
						<ul class="demo-btns">
							<li><a href="add_qac.php?id=<?echo $_GET["id"]?>" class="btn btn-label btn-social btn-facebook"><i class="ti ti-plus"></i>Add</a></li>
						</ul>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h2>Flow Approve QA Check [<?echo $row_QAC_t["cta_name"]?>]</h2>
