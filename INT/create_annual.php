								...
								<div class="col-md-12">
									<div class="panel panel-primary" data-widget='{"id" : "wiget9", "draggable": "false"}'>
										...
										<div class="panel-body">
											<form class="grid-form" action="../ENG/Insert_ann_plan.php?ann_number=<?echo $an_num?>&number=<?echo $data["seq"]?>" method="post" enctype="multipart/form-data" >
												<fieldset>
													<legend>Annual Plan Data</legend>
													<div data-row-span="4">
														<div data-field-span="1">
															<label>No.</label>
															<input type="text" value="<?echo $an_num?>" disabled>
														</div>
														<div data-field-span="1">
															<label>Date</label>
															<input type="text" value="<?echo date("d-M-y")?>" disabled>
														</div>
														<div data-field-span="1">
														...
														<div data-field-span="1">
															...
															<select class="form-control" name="section" required>
																<? echo Select_annual_section($conn)?>
															</select>
														</div>
													</div>
												</fieldset>
